...
df = pandas.read_csv('07 - extração e classificação/dados.csv', delimiter = ';')
...
pickle.dump(model, open('C:/Users/andre/Documents/atividade/teste/opencv/07 - extração e classificação/modelo.pkl', 'wb'))
