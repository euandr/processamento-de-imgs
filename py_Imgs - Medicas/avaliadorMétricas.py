...
file_path = r'C:\Users\andre\Documents\atividades\estudos_opencv\py_Imgs - Medicas\EmSerousOutros.xlsx'
...
print(f"O melhor classificador é: {best_classifier['Seroso VS ']}")
